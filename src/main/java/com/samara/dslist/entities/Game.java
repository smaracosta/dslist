package com.samara.dslist.entities; // A pasta "entities" é onde vai ficar a classe do Banco de Dados.
...
public class Game {
    ...
    @Column(columnDefinition = "TEXT")// Gere como se fosse um texto (+ de 255 caracteres)
